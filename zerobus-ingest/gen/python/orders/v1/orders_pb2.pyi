...
class OrderStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    ORDER_STATUS_PROCESSING: _ClassVar[OrderStatus]
...
class PaymentMethod(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PAYMENT_METHOD_APPLEPAY: _ClassVar[PaymentMethod]
...
ORDER_STATUS_PROCESSING: OrderStatus
...
PAYMENT_METHOD_APPLEPAY: PaymentMethod
...
class OrderLineItem(_message.Message):
    ...
    unit_price: Money
    total_price: Money
    def __init__(self, product_id: _Optional[str] = ..., sku: _Optional[str] = ..., name: _Optional[str] = ..., quantity: _Optional[int] = ..., unit_price: _Optional[_Union[Money, _Mapping]] = ..., total_price: _Optional[_Union[Money, _Mapping]] = ...) -> None: ...
...
class Order(_message.Message):
    ...
    customer_id: str
    status: OrderStatus
    line_items: _containers.RepeatedCompositeFieldContainer[OrderLineItem]
    subtotal: Money
    tax: Money
    shipping_cost: Money
    total: Money
    ...
    created_at: int
    updated_at: int
    def __init__(self, order_id: _Optional[str] = ..., customer_id: _Optional[str] = ..., status: _Optional[_Union[OrderStatus, str]] = ..., line_items: _Optional[_Iterable[_Union[OrderLineItem, _Mapping]]] = ..., subtotal: _Optional[_Union[Money, _Mapping]] = ..., tax: _Optional[_Union[Money, _Mapping]] = ..., shipping_cost: _Optional[_Union[Money, _Mapping]] = ..., total: _Optional[_Union[Money, _Mapping]] = ..., shipping_address: _Optional[_Union[Address, _Mapping]] = ..., billing_address: _Optional[_Union[Address, _Mapping]] = ..., payment_method: _Optional[_Union[PaymentMethod, str]] = ..., payment_id: _Optional[str] = ..., created_at: _Optional[int] = ..., updated_at: _Optional[int] = ...) -> None: ...
